...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Product p2 = new Product(null, "Smart TV", "Nulla eu imperdiet purus. Maecenas sem ante.", 2190.0, "");
		...
		Order o1 = new Order(null, Date.from(Instant.parse("2019-06-20T19:53:07Z")), OrderStatus.PAID, u1);
		Order o2 = new Order(null, Date.from(Instant.parse("2019-07-21T03:42:10Z")), OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Date.from(Instant.parse("2019-07-22T15:21:22Z")), OrderStatus.WAITING_PAYMENT, u1);
